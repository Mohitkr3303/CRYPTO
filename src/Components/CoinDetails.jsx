...
const CoinDetails = () => {
  ...
  if (error) return <Error message={`Error While Fetching Coins Details`} />;
      ...
      <Container maxW={"container.xl"}>
        {loading ? (
          ...
          <>
            ...
            <RadioGroup value={currency} onChange={setcurrency} my={"5"}>
              <HStack spacing={"4"}>
            ...
            <VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
              ...
              <Badge fontSize={"2rem"} bg={"blackAlpha.800"}>
